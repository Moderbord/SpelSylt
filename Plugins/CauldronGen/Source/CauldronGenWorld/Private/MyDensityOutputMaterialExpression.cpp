...
UMaterialExpressionMyDensityOutput::UMaterialExpressionMyDensityOutput(const FObjectInitializer& ObjectInitializer)
...
#if WITH_EDITOR
int32 UMaterialExpressionMyDensityOutput::Compile( FMaterialCompiler* Compiler, int32 OutputIndex)
{
...
void UMaterialExpressionMyDensityOutput::GetCaption(TArray<FString>& OutCaptions) const
{
	OutCaptions.Add(TEXT("Shadeup Advanced Output Node"));
}
#endif // WITH_EDITOR

int32 UMaterialExpressionMyDensityOutput::GetNumOutputs() const
{
	return 2;
}

FString UMaterialExpressionMyDensityOutput::GetFunctionName() const
{
...
FString UMaterialExpressionMyDensityOutput::GetDisplayName() const
{
